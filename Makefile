#############################################################################
# Makefile for building: build/systemtray
# Generated by qmake (3.0) (Qt 5.0.2) on: Sun Jul 14 23:07:54 2013
...
INCPATH       = -I/usr/share/qt5/mkspecs/linux-g++-64 -I. -I/usr/include/qt5 -I/usr/include/qt5/QtSvg -I/usr/include/qt5/QtWidgets -I/usr/include/qt5/QtXml -I/usr/include/qt5/QtGui -I/usr/include/qt5/QtCore -Ibuild/.moc
LINK          = g++
LFLAGS        = -m64 -Wl,-O1
...
SOURCES       = src/main.cpp \
		src/window.cpp build/.rcc/qrc_systray.cpp \
		build/.moc/moc_window.cpp
OBJECTS       = build/.obj/main.o \
		build/.obj/window.o \
		build/.obj/qrc_systray.o \
...
dist: 
	@test -d build/.obj/systemtray1.0.0 || mkdir -p build/.obj/systemtray1.0.0
	$(COPY_FILE) --parents $(SOURCES) $(DIST) build/.obj/systemtray1.0.0/ && $(COPY_FILE) --parents systray.qrc build/.obj/systemtray1.0.0/ && $(COPY_FILE) --parents src/window.h build/.obj/systemtray1.0.0/ && $(COPY_FILE) --parents src/main.cpp src/window.cpp build/.obj/systemtray1.0.0/ && (cd `dirname build/.obj/systemtray1.0.0` && $(TAR) systemtray1.0.0.tar systemtray1.0.0 && $(COMPRESS) systemtray1.0.0.tar) && $(MOVE) `dirname build/.obj/systemtray1.0.0`/systemtray1.0.0.tar.gz . && $(DEL_FILE) -r build/.obj/systemtray1.0.0
...
compiler_rcc_make_all: build/.rcc/qrc_systray.cpp
compiler_rcc_clean:
	-$(DEL_FILE) build/.rcc/qrc_systray.cpp
build/.rcc/qrc_systray.cpp: systray.qrc \
		images/Ruby.png
	/usr/lib/x86_64-linux-gnu/qt5/bin/rcc -name systray systray.qrc -o build/.rcc/qrc_systray.cpp
...
build/.moc/moc_window.cpp: /usr/include/qt5/QtWidgets/QSystemTrayIcon \
		...
		src/window.h
	/usr/lib/x86_64-linux-gnu/qt5/bin/moc $(DEFINES) $(INCPATH) src/window.h -o build/.moc/moc_window.cpp
...
build/.obj/main.o: src/main.cpp /usr/include/qt5/QtGui/QtGui \
...
build/.obj/window.o: src/window.cpp /usr/include/qt5/QtGui/QtGui \
		/usr/include/qt5/QtCore/QtCore \
		/usr/include/qt5/QtCore/qabstractanimation.h \
		/usr/include/qt5/QtCore/qobject.h \
		/usr/include/qt5/QtCore/qobjectdefs.h \
...
build/.obj/qrc_systray.o: build/.rcc/qrc_systray.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/.obj/qrc_systray.o build/.rcc/qrc_systray.cpp
